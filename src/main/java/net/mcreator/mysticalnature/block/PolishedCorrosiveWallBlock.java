...
public class PolishedCorrosiveWallBlock extends MysticalNatureModElements.ModElement {
	@ObjectHolder("mystical_nature:polished_corrosive_wall")
	public static final Block block = null;
	public PolishedCorrosiveWallBlock(MysticalNatureModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_corrosive_wall");
		}
