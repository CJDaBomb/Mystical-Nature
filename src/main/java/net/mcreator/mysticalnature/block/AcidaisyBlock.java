...
import net.mcreator.mysticalnature.procedures.AcidaisyPlantDestroyedByPlayerProcedure;
...
public class AcidaisyBlock extends MysticalNatureModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				AcidaisyPlantDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
