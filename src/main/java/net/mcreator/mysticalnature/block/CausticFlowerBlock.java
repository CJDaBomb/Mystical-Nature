...
import net.mcreator.mysticalnature.procedures.CausticFlowerPlantDestroyedByPlayerProcedure;
...
public class CausticFlowerBlock extends MysticalNatureModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("caustic_flower");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				CausticFlowerPlantDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
