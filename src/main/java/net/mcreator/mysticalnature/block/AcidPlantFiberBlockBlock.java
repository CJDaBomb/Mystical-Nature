...
public class AcidPlantFiberBlockBlock extends MysticalNatureModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOL).sound(SoundType.CROP).hardnessAndResistance(0.5f, 0.5f).lightValue(0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("acid_plant_fiber_block");
		}
