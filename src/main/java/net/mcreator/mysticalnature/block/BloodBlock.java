...
public class BloodBlock extends MysticalNatureModElements.ModElement {
	@ObjectHolder("mystical_nature:blood")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("mystical_nature:blood_bucket")
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("mystical_nature:blocks/blood_still"), new ResourceLocation("mystical_nature:blocks/blood_flow"))
