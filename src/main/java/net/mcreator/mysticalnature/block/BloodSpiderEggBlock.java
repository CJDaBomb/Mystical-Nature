...
import net.mcreator.mysticalnature.procedures.BloodSpiderEggMobplayerCollidesWithPlantProcedure;
...
public class BloodSpiderEggBlock extends MysticalNatureModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.NETHER_WART)
					.hardnessAndResistance(0f, 0f).lightValue(0));
			setRegistryName("blood_spider_egg");
		}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				BloodSpiderEggMobplayerCollidesWithPlantProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
