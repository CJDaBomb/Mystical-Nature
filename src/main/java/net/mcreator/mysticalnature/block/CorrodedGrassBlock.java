...
import net.mcreator.mysticalnature.procedures.CorrodedGrassPlantDestroyedByPlayerProcedure;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				CorrodedGrassPlantDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
