...
public class CorrosivePillarBlock extends MysticalNatureModElements.ModElement {
	@ObjectHolder("mystical_nature:corrosive_pillar")
	public static final Block block = null;
	public CorrosivePillarBlock(MysticalNatureModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("corrosive_pillar");
		}
