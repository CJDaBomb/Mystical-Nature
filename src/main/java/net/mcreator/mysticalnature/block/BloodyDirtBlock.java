...
public class BloodyDirtBlock extends MysticalNatureModElements.ModElement {
	@ObjectHolder("mystical_nature:bloody_dirt")
	public static final Block block = null;
	public BloodyDirtBlock(MysticalNatureModElements instance) {
		super(instance, 157);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("bloody_dirt", "bloody_dirt", blockAt -> {
