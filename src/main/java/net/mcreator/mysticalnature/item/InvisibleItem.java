...
public class InvisibleItem extends MysticalNatureModElements.ModElement {
	@ObjectHolder("mystical_nature:invisible")
	public static final Item block = null;
	@ObjectHolder("mystical_nature:entitybulletinvisible")
	public static final EntityType arrow = null;
	public InvisibleItem(MysticalNatureModElements instance) {
		super(instance, 205);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletinvisible").setRegistryName("entitybulletinvisible"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.5f, 0, 2);
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("mystical_nature:textures/acid_gun_ammo.png");
