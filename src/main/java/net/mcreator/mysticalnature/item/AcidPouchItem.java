...
import net.mcreator.mysticalnature.gui.AcidPouchGUIGui;
...
public class AcidPouchItem extends MysticalNatureModElements.ModElement {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Acid Pouch");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new AcidPouchGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
