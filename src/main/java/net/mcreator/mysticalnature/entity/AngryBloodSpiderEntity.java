...
public class AngryBloodSpiderEntity extends MysticalNatureModElements.ModElement {
	public static EntityType entity = null;
	public AngryBloodSpiderEntity(MysticalNatureModElements instance) {
		super(instance, 193);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.5f, 0.5f)).build("angry_blood_spider")
						.setRegistryName("angry_blood_spider");
