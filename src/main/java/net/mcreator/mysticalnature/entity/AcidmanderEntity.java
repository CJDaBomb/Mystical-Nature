...
public class AcidmanderEntity extends MysticalNatureModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -3342541, -13421773, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("acidmander"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 20, 1, 3));
		}
