...
import net.mcreator.mysticalnature.procedures.CorrosiveSpiderOnInitialEntitySpawnProcedure;
...
public class CorrosiveSpiderEntity extends MysticalNatureModElements.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new SpiderModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("mystical_nature:textures/acidspider.png");
			}
		});
	}
	public static class CustomEntity extends SpiderEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, GastrofrogEntity.CustomEntity.class, true, false));
		...
		public ILivingEntityData onInitialSpawn(IWorld world, DifficultyInstance difficulty, SpawnReason reason, ILivingEntityData livingdata,
			...
			Entity entity = this;
			{
				...
				CorrosiveSpiderOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
