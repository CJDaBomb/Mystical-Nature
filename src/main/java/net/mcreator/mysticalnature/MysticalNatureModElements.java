 ...
 *
 */
package net.mcreator.mysticalnature;
...
public class MysticalNatureModElements {
	...
	public MysticalNatureModElements() {
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == MysticalNatureModElements.ModElement.class)
						elements.add((MysticalNatureModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(MysticalNatureModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new MysticalNatureModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		MysticalNatureMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final MysticalNatureModElements elements;
		protected final int sortid;
		public ModElement(MysticalNatureModElements elements, int sortid) {
