...
import net.mcreator.mysticalnature.procedures.Bloodroot7AdditionalGenerationConditionProcedure;
...
public class Bloodroot7Structure extends MysticalNatureModElements.ModElement {
	public Bloodroot7Structure(MysticalNatureModElements instance) {
		super(instance, 168);
	}
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						int y = spawnTo.getY();
						int z = spawnTo.getZ();
						if (!Bloodroot7AdditionalGenerationConditionProcedure
								.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
							continue;
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("mystical_nature", "bloodroot_7"));
						if (template == null)
							return false;
