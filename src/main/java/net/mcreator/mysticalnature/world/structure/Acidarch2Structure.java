...
import net.mcreator.mysticalnature.procedures.Acidarch2AdditionalGenerationConditionProcedure;
...
public class Acidarch2Structure extends MysticalNatureModElements.ModElement {
	public Acidarch2Structure(MysticalNatureModElements instance) {
		super(instance, 72);
	}
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if ((random.nextInt(1000000) + 1) <= 70000) {
					...
					for (int a = 0; a < count; a++) {
						...
						int y = spawnTo.getY();
						int z = spawnTo.getZ();
						if (!Acidarch2AdditionalGenerationConditionProcedure
