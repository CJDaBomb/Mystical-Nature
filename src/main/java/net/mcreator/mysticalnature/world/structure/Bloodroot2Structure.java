...
import net.mcreator.mysticalnature.procedures.Bloodroot2AdditionalGenerationConditionProcedure;
...
public class Bloodroot2Structure extends MysticalNatureModElements.ModElement {
	public Bloodroot2Structure(MysticalNatureModElements instance) {
		super(instance, 158);
	}
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						int y = spawnTo.getY();
						int z = spawnTo.getZ();
						if (!Bloodroot2AdditionalGenerationConditionProcedure
								.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
							continue;
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("mystical_nature", "bloodroot_2"));
						if (template == null)
							return false;
