...
import net.mcreator.mysticalnature.procedures.Bloodroot6AdditionalGenerationConditionProcedure;
...
public class Bloodroot6Structure extends MysticalNatureModElements.ModElement {
	public Bloodroot6Structure(MysticalNatureModElements instance) {
		super(instance, 151);
	}
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if ((random.nextInt(1000000) + 1) <= 50000) {
					...
					for (int a = 0; a < count; a++) {
						...
						int y = spawnTo.getY();
						int z = spawnTo.getZ();
						if (!Bloodroot6AdditionalGenerationConditionProcedure
								.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
							continue;
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("mystical_nature", "bloodroot_6"));
						if (template == null)
							return false;
